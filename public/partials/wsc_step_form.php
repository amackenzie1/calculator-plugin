                ...
                <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                    <div id="msform" method="post">
                            ...
                            <ul class="progressbar">
                                <li class="progress-step">
                                    ...
                                    <div class="progress-step-icon">
                                        ...
                                        <p class="progress-text">General</p>
                                    </div>
                                </li>
                        ...
                        <div id="first_field" class="first_field-custom">
                                ...
                                <div id="first_section">
                                    ...
                                    <div class="wisely-form-row bg-grey">
                                        ...
                                        <div class="wisely-form-column02">
                                            <div id="hide-field">
                                                <input type="text" id="old_are" name="old_are" placeholder="Age" oninput="validateRange(this)" />
                                            </div>
                                        </div>
                                        <div class="wisely-form-column03">
                                            <div id="show-field" style="display:none;">
                                                <input type="text" id="info_are" name="info_are" placeholder="Age" oninput="validateRange(this)" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="wisely-form-row bg-white">
                                        ...
                                        <div class="wisely-form-column02">
                                            <div id="hide-field">
                                                <input type="text" placeholder="Age" id="life_expect" name="life_expect" oninput="validateRange(this)" />
                                            </div>
                                        </div>
                                        <div class="wisely-form-column03">
                                            <div id="show-field01" style="display:none;">
                                                <input type="text" placeholder="Age" id="estimate_expect" name="estimate_expect" oninput="validateRange(this)" />
                                            </div>
                                        </div>
                                    </div>
                          ...
                          <div id="sp-show-field">
                            <div class="specify_number">
                              <input name="specify_return" id="specify_return" />
                            </div> 
                          </div>
                      </div> -->
                                    </div>
                        ...
                        <div id="second_field">
                            <form id="third_form" method="post">
                                <div id="sf_first_section">
                                    ...
                                    <div class="wisely-form-row bg-grey">
                                        ...
                                        <div class="wisely-form-column02">
                                            <input type="text" id="your_income" class="number_custom" placeholder="$" name="your_income" />
                                        </div>
                                        <div class="wisely-form-column03 spouse-hide-class">
                                            <input type="text" class="number_custom" placeholder="$" id="spouse_income" name="spouse_income" />
                                        </div>
                                    </div>
                                        ...
                                        <div class="wisely-form-row bg-grey">
                                            ...
                                            <div class="wisely-form-column02">
                                                <div class="input_fields_wrap">
                                                    <div>
                                                        <input type="text" class="number_custom" placeholder="$" id="other_income" name="other_income[]" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="wisely-form-column03 spouse-hide-class">
                                                <div class="input_fields_wrap">
                                                    <div>
                                                        <input type="text" class="number_custom" placeholder="$" name="other_spouse_income[]" id="other_spouse_income" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <input id="ps_spouse_age" name="ps_spouse_age" />
                          </div> -->
                                        </div>
                                        <div class="wisely-form-column03 spouse-hide-class">
                                    ...
                                    <div class="wisely-form-row bg-white spouse-pay-show-field">
                                        ...
                                        <div class="wisely-form-column02">
                                            <div class="pension-age-first">
                                                <input class="place-custom" id="pension_age" name="pension_age" placeholder="Age" oninput="validateRange(this)" />
                                            </div>

                                        </div>
                                        <div class="wisely-form-column03 pension-age-second spouse-hide-class">
                                            <input class="place-custom" id="pension_sn_age" name="pension_sn_age" placeholder="Age" oninput="validateRange(this)" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="wisely-form-row bg-white">
                                        ...
                                        <div class="wisely-form-column02">
                                            <input type="text" class="number_custom" placeholder="$" id="pension_amount" name="pension_amount" />
                                        </div>
                                        <div class="wisely-form-column03 spouse-hide-class">
                                            <input type="text" class="number_custom" placeholder="$" id="pension_sn_amount" name="pension_sn_amount" />
                                        </div>
                                    </div>
                            ...
                            <input id="sc_spouse_age" name="sc_spouse_age" />
                          </div> -->
                                        </div>
                                        <div class="wisely-form-column03 spouse-hide-class">
                                    ...
                                    <div class="wisely-form-row bg-white security-pay-show-field">
                                        ...
                                        <div class="wisely-form-column02">
                                            <div class="security-age-first">
                                                <input class="place-custom" id="security_age" name="security_age" placeholder="Age" oninput="validateRange(this)" />
                                            </div>
                                        </div>
                                        <div class="wisely-form-column03 security-age-second spouse-hide-class">
                                            <input class="place-custom" id="security_sn_age" name="security_sn_age" placeholder="Age" oninput="validateRange(this)" />
                                        </div>
                                    </div>

                                    <div class="wisely-form-row bg-white">
                                        <div class="wisely-form-column01">
                                            <label class="fieldlabels">What is the annual amount (before tax)? <span class="tootltip-icon" title="The minimum income threshold for 2023 is $86,912. If your OAS pension will be clawed back you should still enter the full gross amount. We will calculate the clawback for you and add this amount to your income tax owing. <br />If you don’t know what your monthly OAS payments will be, you can sign in to your My Service Canada Account for your monthly OAS estimate."><i class="fa-sharp fa-solid fa-circle-info"></i></span></label>
                                        </div>
                                        <div class="wisely-form-column02">
                                            <input type="text" class="number_custom" placeholder="$" id="security_amount" name="security_amount" />
                                        </div>
                                        <div class="wisely-form-column03 spouse-hide-class">
                                            <input type="text" class="number_custom" placeholder="$" id="security_sn_amount" name="security_sn_amount" />
                                        </div>
                                    </div>
                            ...
                            <input id="bp_spouse_age" name="bp_spouse_age"/>
                          </div> -->
                                        </div>
                                        <div class="wisely-form-column03 spouse-hide-class">
                                    ...
                                    <div class="wisely-form-row bg-white benifit-pay-show-field">
                                        ...
                                        <div class="wisely-form-column02">
                                            <div class="benifit-age-first">
                                                <input class="place-custom" id="benifit_age" name="benifit_age" placeholder="Age" oninput="validateRange(this)" />
                                            </div>
                                        </div>
                                        <div class="wisely-form-column03 benifit-age-second spouse-hide-class">
                                            <input class="place-custom" id="benifit_sn_age" name="benifit_sn_age" placeholder="Age" oninput="validateRange(this)" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="wisely-form-row bg-white">
                                        ...
                                        <div class="wisely-form-column02">
                                            <input type="text" class="number_custom" placeholder="$" id="benifit_amount" name="benifit_amount" />
                                        </div>
                                        <div class="wisely-form-column03 spouse-hide-class">
                                            <input type="text" class="number_custom" placeholder="$" id="benifit_sn_amount" name="benifit_sn_amount" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="wisely-form-row bg-grey">
                                        ...
                                        <div class="wisely-form-column02">
                                            ...
                                            <div id="index-show-field" style="display:none;">
                                                <!-- <input id="index_spouse_age" name="index_spouse_age" /> -->
                                            </div>
                                        </div>
                                        <div class="wisely-form-column03 spouse-hide-class">
                        ...
                        <div id="third_field">
                            <form id="fifth_form" method="post">
                                <div id="td_first_section">
                                    ...
                                    <div class="first_field-custom-wrap">
                                        <div class="wisely-form-column01">
                                            <p>Registered Investments<span class="tootltip-icon" data-html="true" title="Tax-Free Savings Account(TFSA): When money is withdrawn from your TSFA it is not taxable.<br /> Registered Retirement Savings Plan (RRSP): When money is withdrawn from your RRSP account it is taxable. At age 71 your RRSP account, if you have one, will automatically convert into a RRIF account. <br /> Registered Retirement Income Fund (RRIF): At age 71 RRSPs must be converted to a RRIF. We will calculate the withdrawal amount for your income each year. <br /> Locked-in Retirement Account (LIRA): If you have contributed to a Defined Contribution Pension Plan you may have a LIRA. At age 71 we will automatically convert your LIRA account into a LIF account. <br /> Life Income Fund (LIF): Use this if you have a LIRA account that has been converted to a LIF (Life Income Fund). We will calculate the withdrawal amount for your income each year. <br />"><i class="fa-sharp fa-solid fa-circle-info"></i></span></p>
                                        </div>
                                        <div class="wisely-form-column02 field-icon-wrap">
                                            <i class="fa-regular fa-person"></i>
                                            <p>You</p>
                                        ...
                                        <div class="wisely-form-row bg-white">
                                            ...
                                            <div class="wisely-form-column02">
                                                <div class="spouse_account_wrap">
                                                    <div>
                                                        <input type="text" class="number_custom" placeholder="$" id="account_value" name="account_value[]" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="wisely-form-column03 spouse-hide-class">
                                                <div class="spouse_account_wrap">
                                                    <div>
                                                        <input type="text" class="number_custom" placeholder="$" id="spouse_value" name="spouse_value[]" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="wisely-form-row bg-grey">
                                        ...
                                        <div class="wisely-form-column02">
                                            <input type="text" class="number_custom" placeholder="$" id="ct_account_value" name="ct_account_value" />
                                        </div>
                                        <div class="wisely-form-column03 spouse-hide-class">
                                            <input type="text" class="number_custom" placeholder="$" id="st_account_value" name="st_account_value" />
                                        </div>
                                    </div>
                                    <div class="wisely-form-row bg-white">
                                        <div class="wisely-form-column01">
                                        ...
                                        <div class="wisely-form-column02">
                                            <input type="text" class="number_custom" placeholder="$" id="ct_book_value" name="ct_book_value" />
                                        </div>
                                        <div class="wisely-form-column03 spouse-hide-class">
                                            <input type="text" class="number_custom" placeholder="$" id="st_book_value" name="st_book_value" />
                                        </div>
                                    </div>
                                    <div class="wisely-form-row bg-white">
                                        <div class="wisely-form-column100 green-line">
                                    ...
                                    <div class="wisely-form-row bg-grey">
                                        ...
                                        <div class="wisely-form-column02">
                                            <input type="text" class="number_custom" placeholder="$" id="estate_value" name="estate_value" />
                                        </div>
                                        <div class="wisely-form-column03 spouse-hide-class">
                                            <input type="text" class="number_custom" placeholder="$" id="se_estate_value" name="se_estate_value" />
                                        </div>
                                    </div>
                                    <!--                   <div class="wisely-form-row bg-white">
                      <div class="wisely-form-column01">
                            ...
                            <form id="six_form" method="post">
                                <div id="td_second_section">
                                    ...
                                    <div class="wisely-form-row bg-grey">
                                        ...
                                        <div class="wisely-form-column02">
                                            <input type="text" class="number_custom" placeholder="$" id="primary_value" name="primary_value" />
                                        </div>
                            ...
                            <form id="seven_form" method="post">
                                <div id="fr_first_section">
                                    ...
                                    <div class="wisely-form-row bg-grey">
                                        ...
                                        <div class="wisely-form-column02">
                                            <input type="text" class="number_custom" placeholder="$" name="annual_expense" id="annual_expense">
                                        </div>
                                        <div class="wisely-form-column03 spouse-hide-class">
                                            <input type="text" class="number_custom" placeholder="$" name="se_annual_expense" id="se_annual_expense">
                                        </div>
                                    </div>
                                    ...
                                    <div class="wisely-form-row bg-white">
                                        ...
                                        <div class="wisely-form-column02">
                                            <div id="">
                                                <input type="text" class="number_custom" placeholder="$" name="care_expense" id="care_expense">
                                            </div>
                                        </div>
                                        <div class="wisely-form-column03 spouse-hide-class">
                                            <div id="">
                                                <input type="text" class="number_custom" placeholder="$" name="se_care_expense" id="se_care_expense">
                                            </div>
                                        </div>
                                    </div>
                              ...
                              <input type="text" class="number_custom" placeholder="$" id="prefer_value" name="prefer_value" />
                            </div> -->
                                        </div>
                                        <div class="wisely-form-column03 spouse-hide-class">
                                    ...
                                    <div class="expense-amounts-hide" style="display:none;">
                                        <div class="wisely-form-row bg-white">
                                            <div class="wisely-form-column100 orange-line">
                                                <h3>Retirement Stage 1: Current Age to 75 <span class="tootltip-icon" title="People usually spend 15%-25% less on discretionary and non-discretionary expenses approaching the age of 75. <br />Experts estimate between $40,000 to $70,000 to cover the annual spending needs for most single retired Canadians. For a retired couple, the range might be between $50,000 to $80,000. <br />As a precaution, you could increase your health spending estimates by 15%-25% nearing the age of 75."><i class="fa-sharp fa-solid fa-circle-info"></i></span></h3>
                                            </div>
                                        </div>
                                        ...
                                        <div class="retirement-stage-1">
                                            <div class="wisely-form-row bg-grey">
                                                ...
                                                <div class="wisely-form-column02">
                                                    <div class="retirement-first" style="display:none;">
                                                        <input type="text" class="number_custom" placeholder="$" name="annual_age" id="annual_age">
                                                    </div>
                                                </div>
                                                <div class="wisely-form-column03 spouse-hide-class">
                                                    <div class="retirement-second" style="display:none;">
                                                        <input type="text" class="number_custom" placeholder="$" name="spouse_annual_age" id="spouse_annual_age">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="wisely-form-row bg-white">
                                                ...
                                                <div class="wisely-form-column02">
                                                    <div class="retirement-first" style="display:none;">
                                                        <input type="text" class="number_custom" placeholder="$" name="care_age" id="care_age">
                                                    </div>
                                                </div>
                                                <div class="wisely-form-column03 spouse-hide-class">
                                                    <div class="retirement-second" style="display:none;">
                                                        <input type="text" class="number_custom" placeholder="$" name="spouse_care_age" id="spouse_care_age">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="wisely-form-row bg-white">
                                            <div class="wisely-form-column100 orange-line">
                                                <h3>Retirement Stage 2: Ages 76 to 85 <span class="tootltip-icon" title="Expect to reduce spending by a further 15%-25% on discretionary and non-discretionary expenses by the age of 85. You may spend less on travel, clothes, drinking, dining, etc. <br />Depending on your situation, health care expenses may increase by a further 15%-25% nearing the age of 85."><i class="fa-sharp fa-solid fa-circle-info"></i></span></h3>
                                            </div>
                                        </div>
                                        <div class="retirement-stage-2">
                                            <div class="wisely-form-row bg-grey">
                                                ...
                                                <div class="wisely-form-column02">
                                                    <div class="retirement-first" style="display:none;">
                                                        <input type="text" class="number_custom" placeholder="$" name="second_annual_age" id="second_annual_age">
                                                    </div>
                                                </div>
                                                <div class="wisely-form-column03 spouse-hide-class">
                                                    <div class="retirement-second" style="display:none;">
                                                        <input type="text" class="number_custom" placeholder="$" name="spouse_se_annual_age" id="spouse_se_annual_age">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="wisely-form-row bg-white">
                                                ...
                                                <div class="wisely-form-column02">
                                                    <div class="retirement-first" style="display:none;">
                                                        <input type="text" class="number_custom" placeholder="$" name="second_care_age" id="second_care_age">
                                                    </div>
                                                </div>
                                                <div class="wisely-form-column03 spouse-hide-class">
                                                    <div class="retirement-second" style="display:none;">
                                                        <input type="text" class="number_custom" placeholder="$" name="spouse_se_care_age" id="spouse_se_care_age">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="wisely-form-row bg-white">
                                            <div class="wisely-form-column100 orange-line">
                                                <h3>Retirement Stage 3: Ages 86 to Life Expectancy <span class="tootltip-icon" title="Keep in mind that maintaining your health will likely take full priority during this period, so expect to allocate just a small amount towards non-discretionary expenses while most of it will go towards health care. <br />Experts estimate annual health costs ranging from $60,000 to $100,000 for single Canadians."><i class="fa-sharp fa-solid fa-circle-info"></i></span></h3>
                                            </div>
                                        </div>
                                        <div class="retirement-stage-3">
                                            ...
                                            <div class="wisely-form-row bg-grey">
                                                ...
                                                <div class="wisely-form-column02">
                                                    <div class="retirement-first" style="display:none;">
                                                        <input type="text" class="number_custom" placeholder="$" name="third_annual_age" id="third_annual_age">
                                                    </div>
                                                </div>
                                                <div class="wisely-form-column03 spouse-hide-class">
                                                    <div class="retirement-second" style="display:none;">
                                                        <input type="text" class="number_custom" placeholder="$" name="spouse_th_annual_age" id="spouse_th_annual_age">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="wisely-form-row bg-white">
                                                ...
                                                <div class="wisely-form-column02">
                                                    <div class="retirement-first" style="display:none;">
                                                        <input type="text" class="number_custom" placeholder="$" name="third_care_age" id="third_care_age">
                                                    </div>
                                                </div>
                                                <div class="wisely-form-column03 spouse-hide-class">
                                                    <div class="retirement-second" style="display:none;">
                                                        <input type="text" class="number_custom" placeholder="$" name="spouse_th_care_age" id="spouse_th_care_age">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div id="five_field">
                            <form id="nine_form" method="post">
                                <div id="five_first_section">
                                        ...
                                        <div class="wisely-form-row bg-grey">
                                            ...
                                            <div class="wisely-form-column02">
                                                <div class="expense_wrap">
                                                    <div>
                                                        <input type="text" class="number_custom" placeholder="$" name="expense_type_main_val[]" id="expense_type_main_val">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="wisely-form-column03 spouse-hide-class">
                                                <div class="expense_wrap">
                                                    <div>
                                                        <input type="text" class="number_custom" placeholder="$" name="expense_type_spouse_val[]" id="expense_type_spouse_val">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="wisely-form-row bg-grey">
                                            ...
                                            <div class="wisely-form-column02">
                                                <div class="donate_wrap">
                                                    <div>
                                                        <input type="text" class="number_custom" placeholder="$" name="donate_plan_main[]" id="donate_plan_main">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="wisely-form-column03 spouse-hide-class">
                                                <div class="donate_wrap">
                                                    <div>
                                                        <input type="text" class="number_custom" placeholder="$" name="donate_plan_spouse[]" id="donate_plan_spouse">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="wisely-form-row bg-white">
                                        <div class="wisely-form-column100 orange-line">
                                            <h3>Desired Estate (to be left to heirs) <span class="tootltip-icon" title="Please state your desired estate amount (if any) you’d like to leave behind to your family, heirs, and charities at your life expectancy age. Stating this amount will help determine whether you have a surplus by excluding the amount from the projections in your retirement years. The amount is then added back into your net estate at life expectancy. Note: Keep in mind that if you have included a life insurance policy as part of your calculations, the death benefit of the policy will also be added to your total net estate at life expectancy. <br />If you have included a spouse as part of your calculations, please use the desired estate amount as a combined total for both of you."><i class="fa-sharp fa-solid fa-circle-info"></i></span></h3>
                                        </div>
                                    </div>

                                    <div class="wisely-form-row bg-grey">
                                        <div class="wisely-form-column01">
                                            <label> <?php _e("How much (in dollars with today’s purchasing power) would you like to leave behind to your family, heirs and charities?"); ?> <span class="tootltip-icon" title="There are 3 possible answers to consider: <br /><br />1. The minimum - You know your heirs the best, so you should decide on the minimum amount you consider to be an appropriate inheritance. If you are conservative in your assumptions, i.e., planning to live to age 100, planning for higher than expected living expenses, and lower than expected revenues, then the estate will probably be higher than the minimum amount considered to be appropriate. But by entering the minimum acceptable amount it is possible to determine if you have a surplus – even if you spend more than expected and live to age 100. <br /><br />2. Whatever is left over - If you are not concerned about leaving an estate then you should enter a nominal amount to cover funeral and estate costs. By entering this amount you will be able to determine if you currently have a surplus that could be used for a better lifestyle, to help heirs now, or to support some cause that is important to you. <br /><br />3. Leaving as much as possible it will not be possible to calculate a ‘surplus’ because all of your capital is necessary to achieve the ‘as much as possible’ goal. We suggest spending less and purchasing whole life insurance to achieve the ‘as much as possible’ goal. The calculator will still be useful in that it will show you how large the estate is likely to be based on current spending and how much larger it could be if you reduce spending. <br /><br />Note: If you’re a Surplus member, you can access the desired estate worksheet to help you calculate this. "><i class="fa-sharp fa-solid fa-circle-info"></i></span></label>
                                        </div>
                                        <div class="wisely-form-column02">
                                            <div class="expense_wrap">
                                                <div>
                                                    <input type="text" class="number_custom" placeholder="$" name="desired_estate_main" id="desired_estate_main">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
